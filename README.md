...
To build the final jar and optimize the DevNetSuivi application for production, run:
...
Then navigate to [http://localhost:8300](http://localhost:8300) in your browser.
